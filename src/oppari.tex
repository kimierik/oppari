...
% uusiks. en tiedä onko sitaatti oikea
...
ja koska monet kielet on hyvin erillaisia konteksti ja nuanssi voi hävitä jos kääntää vain sana sanaan. % voi hävitä jos kääntää huonosti??
Monet lausahdukset ja sanonnat ei voi kääntää suoraan kielestä toiseen ilman että menettää sen alkuperäisen tarkoituksen. \citemissing
%more idk if gpt can expand this
\medskip
...
tekoaly käännös on tosi nopea ja halpa, mutta ei vielä ole tarpeeksi tarkka kaikkiin käyttötarkoituksiin.\citemissing
\medskip
