...
NoSql = eng "non sql" tai "not only sql". Ei relatiivi tietokantajärjestelmä. 
\bigskip
...
Uudet työkalut, ohjelmointikielet ja toimintatavat muuttavat (miten tehdään ja mitä tehdään).
%needs more
\medskip
...
% nämä tarvitsevat ihan vitusti lisää tekstiä
% mutta ensiksi tee näistä lauseita jotka sanovat jotain


Opinnäytettyössä seurattiin kehittymistä seurantajakson ainaka.
Päiväkirja antaa silmäyksen alan-ammattilaisen työhön ja sen haastaisiin.
%
Päiväkirja antoi syvällisemmän tavan opiskella käytettyjä teknologioita, 
%
% selitä paremmin että itse kirjoitettu teksti on syvällisempi tapa oppia jotain kun vaan sen käyttäminen
sillä niistä tietojen etsiminen ja niiden kirjaaminen ei olisi muuten tapahtunut??..
\medskip


% tuntuu jotenkin huonolta kappaleelta
%
opin käyttämään projektissa käytettyjä teknologioita.
% mitä voi sanoa näiden teknologioiden oppimisesta.....
% miten liittyy opparin tarkoitukseen ja juttuihin
Projektissa käytettyjen teknologioiden oppimisessa ja oppimis prosessin kirjaamisessa......(jotaqin lisää)
%
\medskip


sain kokemusta ammatti työstä.
itsenäistä tekemistä, ominaisuuksien toteuttamisen suunnittelemista ja niiden lisäämistä sovellukseen.
projektin sisäinen kommunikaatio ja sosiaaliset taidot. palaverit ym
\medskip
...
tämä kokemus auttaa tulevaisuudessa. 
Työkokemus tulee auttamaan tulevaisuudessa, teknisten taitojen ja sosiaalisten taitojen kanssa.
teknisten taitojen myöksi opin sosiaalisia taitoja.
%
Kollaboratiivisissa projekteissa pitää osata kommunikoida muiden projektin jäsenien kanssa.
Omat mielipiteet toteutus toiveista pitää osata ilmaista teknisesti, ja palavereissa pitää osata kertoa mitä on tehnyt asiakielella.
\medskip
