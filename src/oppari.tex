...
%Viikoittaisten palavereihin osallistuminen ja viikon aikana tehtyjen töiden esittely 
%ja selittäminen on oleellinen osa isommassa projektissa työskentelemistä.
\medskip
...
%Nämä osat pitää olla jatkuvasti toiminnassa ja yhteyksissä toisiinsa sovelluksien toimintaan ja niiden katkeaminen voi
...
Startup- ja muut kasvuyritykset hakevat nopeaa ja ketterää kehitystä markkinoilla pärjäämiseen.\labcite{fikrahub}
...
Projektin teknologia pino pohjautuu MeteorJs kehykseen, joka on suunniteltu nopeaan kehittämiseen ja käyttöönottoon.\labcite{meteor24b}
...
%MongoDBn skeematon dokumenttirakenne, tuo helpon tavan päivittää skeemoja tarpeiden tullen.
\medskip
...
ja mahdollistaa ehdollisen CSS tyylien asettelun.\labcite{mozilla24c}
...
\newpage
\addPageOp{src/op/feature.tex}{Uuden ominaisuuden lisäys} % ------------------------------- FEATURE ------------------------------- %
