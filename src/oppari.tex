...
Teknologia ala on nopeasti liikkuva, uusien teknologioiden kehittyessä vanhat teknologiat poistyvat käytöstä.
Alan-ammattilaisen pitää pysyä valppaana, ja aktiivisesti opiskella uusia teknologioita, 
että hän pystyisi pysymään ajantasalla nykyisistä industry trendeistä.
%needs more
\medskip
