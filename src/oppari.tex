...
% etsi sitaatit kaikkiin missing src kohtiin
% joku lähde ja laita se biblioon 
...
Verkkosivujen suunnittelussa tätä lähestymistapaa kutsutaan responsiiviseksi suunnitteluksi. \citemissing
\medskip
...
%tämä ainakin uusiks
Säännökset voivat olla esimerkiksi "jos näytön koko on pienempi kuin X".\citemissing
...
sen näytön koosta tai kuvasuhteesta.\citemissing
