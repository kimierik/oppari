...
jotka varmistavat suhteet ja ylläpitävät tietojen eheyttä koko tietokannassa.\labciteend{mongodb24k}
\medskip
...
että jokaisella kokoelman asiakirjalla voi olla erilainen rakenne.\labciteend{mongodb24k}
\medskip

\bigskip
\includegraphics{src/public/oppar/mongodb-structure.jpg} \\
Kuva \getImgCount. Kaavio dokumentti- ja relaatio kanta mallin termejen eroista\labimgcite{lamba18}
\medskip
...
eikä niillä tarvitse olla samoja kenttiä.\labciteend{mongodb24k}
\medskip
