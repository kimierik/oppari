...
Meteor mahdollistaa isomorphiseen koodin kirjoittamisen, eli koodiin, joka on samanlaista palvelimella kuten clientillä.\labcite{Kuster23} % en tiedä onko hyvä src mutta on totta joten pitäis löytää jokue
...
Käyttäjä paketin avusta kehitäjä voi nopeasti luoda authentikaatio järjestelmän,
joka antaa helpon integraation muiden kirjautumis palvelujen kanssa kuten facebook, github, google ym.
...
% metodit tekee koodista yksinkertaisempaa... jotenkin outo
...
Jos käyttäjä on kirjautunut sisään tulostetaan argumentit objekti. 
\medskip
