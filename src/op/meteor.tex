...
Lisäksi Meteor \labcite{meteor24b}:
\begin{itemize}
...
jonka avulla paketin kehittäjä voi määritellä, mitkä osat ladataan selain puolelle ja mitkä palvelimelle.\labcite{meteor24d}
